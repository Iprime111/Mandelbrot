...
static const char *BACKEND_NAMES [CPU_BACKENDS_COUNT + 1] = {"Naive CPU", "Array optimized CPU", "SIMD optimized CPU", "GPU"};
...
const char SHADER_PATH []               = "%s/shaders/shader.glsl";
const char FONT_PATH   []               = "%s/fonts/JetBrainsMono-Bold.ttf";
